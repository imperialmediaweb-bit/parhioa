...
const WEEK: { day: string; services: Service[] }[] = [
  { day: 'Luni', services: [{ time: '08:00', name: 'Acatistul Sf. Arhangheli' }] },
  { day: 'Marți', services: [{ time: '08:00', name: 'Acatistul Sf. Ioan Botezătorul' }] },
  { day: 'Miercuri', services: [{ time: '08:00', name: 'Acatistul Maicii Domnului' }] },
  { day: 'Joi', services: [{ time: '08:00', name: 'Acatistul Sf. Nicolae' }] },
  { day: 'Vineri', services: [{ time: '08:30', name: 'Sf. Maslu' }] },
  {
    day: 'Sâmbătă',
    services: [{ time: '11:00', name: 'Pomenirea morților' }],
  },
  {
    day: 'Duminică',
    services: [
